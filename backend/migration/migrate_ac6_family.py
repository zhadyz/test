#!/usr/bin/env python
"""
AC-6 Family Migration Script
Migrates AC-6 (base), AC-6(1), and AC-6(9) - Least Privilege Controls
Phase 4: Systematic alphabetical migration
"""
...
CAC_TO_CATALOG_MAPPING = {
    'ac-6': 'ac-6',          # Base control
    'ac-6(1)': 'ac-6.1',     # Enhancement 1
    'ac-6(9)': 'ac-6.9'      # Enhancement 9
}

def main():
    print("="*80)
    print("AC-6 FAMILY MIGRATION - Least Privilege Controls")
    print("="*80)
    print()
    ...
    cac_controls = ['ac-6', 'ac-6(1)', 'ac-6(9)']
    ...
    backup_path = backup_dir / f"controls_catalog_{timestamp}_pre_AC6_family.json"
    ...
    for catalog_id, scripts in rendered_scripts.items():
        ...
        control['metadata']['migration_source'] = 'CAC_AC6_family_migration'
    ...
    print(f"\n[SUCCESS] AC-6 Family Migration Complete")
    print(f"\nControls Migrated:")
    for catalog_id in rendered_scripts.keys():
    ...
    print("\n" + "="*80)
    print("NEXT STEPS:")
    print("  1. Validate via API: python validate_migration.py --control ac-6")
    print("  2. Test frontend integration")
    print("  3. Proceed to AC-7 family migration")
    print("="*80)
